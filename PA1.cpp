	...
	string encodeing)
{
	...
	{
		//not a leaf make a recursive call
	...
	{
		//this is a leaf
		//this means we need a complete mapping for this character
		//this converts node, which is a huffman node into a leaf node
		//				convert that type that we wa t, what we want to convert
